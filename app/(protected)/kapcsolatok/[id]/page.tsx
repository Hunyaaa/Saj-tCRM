...
export default async function ContactDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-4">
      <Card>
        <div className="flex items-center justify-between gap-2"><h1 className="text-2xl font-bold">{contact.full_name}</h1><Link href={`/kapcsolatok/${id}/szerkesztes`} className="rounded-lg border px-3 py-1 text-sm hover:bg-slate-50">Szerkesztés</Link></div>
